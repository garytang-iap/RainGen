...
from model.video_model.attention import SpatialTransformer
from model.video_model.util import (avg_pool_nd, conv_nd, linear,
                                              normalization,
...
class TimestepEmbedSequential(nn.Sequential, TimestepBlock):
    ...
    def forward(
        ...
        from model.video_model.video_model import VideoResBlock, PostHocResBlockWithTime
